...
// const url='https://www.youtube.com/playlist?list=PLq6VRa9K5EXAS6y1CcrcY2uaJsPntfRlW';//
const url='https://www.youtube.com/playlist?list=PLPJJMSJa6jiH7ROHcjE653keSaQ59Vo6T'
// const f_lead='生活百科11';
const maxcnt = 356;
...
;(async () => {
  ...
  'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.125 Safari/537.36'
    ...
    const f_lead=await  chineseConv.tify(await page.$eval('a.yt-simple-endpoint.style-scope.yt-formatted-string',(el)=>el.textContent.trim()));
